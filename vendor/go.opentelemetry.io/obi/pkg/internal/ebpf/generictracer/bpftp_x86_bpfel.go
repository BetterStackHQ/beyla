...
type BpfTPCallProtocolArgsT struct {
	...
	ProtocolType    BpfTPProtocolType
	Ssl             uint8
	Direction       uint8
	PacketType      uint8
	SmallBuf        [24]uint8
...
type BpfTPProtocolType uint8

const (
	BpfTPProtocolTypeK_protocolTypeUnknown  BpfTPProtocolType = 0
	BpfTPProtocolTypeK_protocolTypeMysql    BpfTPProtocolType = 1
	BpfTPProtocolTypeK_protocolTypePostgres BpfTPProtocolType = 2
)
